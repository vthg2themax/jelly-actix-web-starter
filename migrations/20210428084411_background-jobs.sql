-- This migration comes from the sqlxmq project, and is copied into here for convenience.
--
-- Their repo recommends it: https://github.com/Diggsey/sqlxmq
--
-- If you need something beyond a database-backed job queue, then you're at a point where
-- customizing the install makes sense. :)
